...
@Component({
  selector: 'app-instamojo-payment',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './instamojo-payment.html',
})
export class InstamojoPayment {
  ...
  constructor(
    ...
    this.paymentForm.controls['slug'].patchValue('instamojo');
    this.locale();
    this.getPaymentInfo();
  }
      ...
      next: (response: any) => {
        ...
        if (response && response.id) {
          ...
          if (response && response.credentials && response.credentials instanceof Object) {
            ...
            this.paymentForm.controls['credentials'].controls['token'].setValue(response && response.credentials && response.credentials.token ? response.credentials.token : '');
          }
