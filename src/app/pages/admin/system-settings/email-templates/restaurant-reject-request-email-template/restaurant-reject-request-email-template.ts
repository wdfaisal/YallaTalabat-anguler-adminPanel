...
@Component({
  selector: 'app-restaurant-reject-request-email-template',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, AngularEditorModule, SafeHtmlPipe],
  templateUrl: './restaurant-reject-request-email-template.html',
})
export class RestaurantRejectRequestEmailTemplate extends EmailTemplatePreviewBase {
  ...
  constructor(
    ...
    this.slug = 'restaurant-register-request-rejected';
