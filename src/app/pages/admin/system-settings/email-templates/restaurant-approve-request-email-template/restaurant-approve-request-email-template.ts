...
@Component({
  selector: 'app-restaurant-approve-request-email-template',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, AngularEditorModule, SafeHtmlPipe],
  templateUrl: './restaurant-approve-request-email-template.html',
})
export class RestaurantApproveRequestEmailTemplate extends EmailTemplatePreviewBase {
  ...
  constructor(
    ...
    this.slug = 'restaurant-register-request-approved';
