...
@Component({
  selector: 'app-dining-booking-refund-request-email-template-form',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, AngularEditorModule, SafeHtmlPipe],
  templateUrl: './dining-booking-refund-request-email-template-form.html',
})
export class DiningBookingRefundRequestEmailTemplateForm extends EmailTemplatePreviewBase {
  ...
  constructor(
    ...
    this.slug = 'user-dining-booking-refund-request';
