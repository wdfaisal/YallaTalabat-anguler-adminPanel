...
@Component({
  selector: 'app-feedback-thank-you-form',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, AngularEditorModule, SafeHtmlPipe],
  templateUrl: './feedback-thank-you-form.html',
})
export class FeedbackThankYouForm extends EmailTemplatePreviewBase {
