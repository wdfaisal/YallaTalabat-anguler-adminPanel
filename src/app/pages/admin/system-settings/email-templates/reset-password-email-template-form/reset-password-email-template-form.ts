...
@Component({
  selector: 'app-reset-password-email-template-form',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, AngularEditorModule, SafeHtmlPipe],
  templateUrl: './reset-password-email-template-form.html',
})
export class ResetPasswordEmailTemplateForm extends EmailTemplatePreviewBase {
