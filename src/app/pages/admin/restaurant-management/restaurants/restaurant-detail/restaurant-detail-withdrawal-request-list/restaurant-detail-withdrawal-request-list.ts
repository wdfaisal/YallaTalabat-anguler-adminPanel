...
@Component({
  selector: 'app-restaurant-detail-withdrawal-request-list',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './restaurant-detail-withdrawal-request-list.html',
})
export class RestaurantDetailWithdrawalRequestList implements AfterViewInit {
  ...
  getList() {
    ...
    this.api.get_private('v1/admin/vendor_detail/withdrawal_request_list?' + httpParams.toString()).subscribe({
      next: (response: any) => {
