...
@Component({
  selector: 'app-dialog-delivery-time-picker',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-delivery-time-picker.html',
})
export class DialogDeliveryTimePicker {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogDeliveryTimePicker>,
