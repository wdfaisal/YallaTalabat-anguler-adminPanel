...
import { DialogCancelTiffinSubscriptionRefund } from './dialog-cancel-tiffin-subscription-refund/dialog-cancel-tiffin-subscription-refund';
import { DialogGiveTiffinSubscriptionRefund } from './dialog-give-tiffin-subscription-refund/dialog-give-tiffin-subscription-refund';
...
@Component({
  selector: 'app-tiffin-subscription-refund-request-info',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './tiffin-subscription-refund-request-info.html',
})
export class TiffinSubscriptionRefundRequestInfo {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/admin/tiffin_subscription_refund_request/info/' + this.id).subscribe({
      next: (response: any) => {
  ...
  onCancelRefundRequest() {
    const dialogRef = this.dialog.open(DialogCancelTiffinSubscriptionRefund, {
  ...
  onGiveRefund() {
    const dialogRef = this.dialog.open(DialogGiveTiffinSubscriptionRefund, {
