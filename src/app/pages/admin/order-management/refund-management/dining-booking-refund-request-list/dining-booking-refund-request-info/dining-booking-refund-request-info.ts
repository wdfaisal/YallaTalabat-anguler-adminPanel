...
import { DialogDiningBookingCancelRefundRequest } from './dialog-dining-booking-cancel-refund-request/dialog-dining-booking-cancel-refund-request';
import { DialogDiningBookingGiveRefund } from './dialog-dining-booking-give-refund/dialog-dining-booking-give-refund';
...
@Component({
  selector: 'app-dining-booking-refund-request-info',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './dining-booking-refund-request-info.html',
})
export class DiningBookingRefundRequestInfo {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/admin/dining_booking_refund_request/info/' + this.id).subscribe({
      next: (response: any) => {
  ...
  onCancelRefundRequest() {
    const dialogRef = this.dialog.open(DialogDiningBookingCancelRefundRequest, {
  ...
  onGiveRefund() {
    const dialogRef = this.dialog.open(DialogDiningBookingGiveRefund, {
