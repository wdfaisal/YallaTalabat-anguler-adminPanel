...
@Component({
  selector: 'app-dialog-dining-booking-cancel-refund-request',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-dining-booking-cancel-refund-request.html',
})
export class DialogDiningBookingCancelRefundRequest {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogDiningBookingCancelRefundRequest>,
  ...
  onSubmit() {
    ...
    if (this.cancelForm.valid) {
      ...
      this.isSubmit = true;
      this.api.post_private('v1/admin/dining_booking_refund_request/cancel', this.cancelForm.value).subscribe({
        next: (response: any) => {
