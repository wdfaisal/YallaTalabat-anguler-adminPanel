...
@Component({
  selector: 'app-dialog-cancel-refund',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-cancel-refund.html',
})
export class DialogCancelRefund {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogCancelRefund>,
  ...
  onSubmit() {
    ...
    if (this.cancelForm.valid) {
      ...
      this.isSubmit = true;
      this.api.post_private('v1/admin/refund_request/cancel', this.cancelForm.value).subscribe({
        next: (response: any) => {
