...
@Component({
  selector: 'app-vendors-pos-order-invoice-print',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './vendors-pos-order-invoice-print.html',
})
export class VendorsPosOrderInvoicePrint {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/admin/posOrders/invoice/' + this.id).subscribe({
      next: (response: any) => {
