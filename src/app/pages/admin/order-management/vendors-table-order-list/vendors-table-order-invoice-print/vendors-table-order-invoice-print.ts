...
@Component({
  selector: 'app-vendors-table-order-invoice-print',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './vendors-table-order-invoice-print.html',
})
export class VendorsTableOrderInvoicePrint {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/admin/tableOrders/invoice/' + this.id).subscribe({
      next: (response: any) => {
