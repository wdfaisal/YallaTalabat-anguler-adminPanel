...
@Component({
  selector: 'app-dialog-admin-tiffin-subscription-notice',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-admin-tiffin-subscription-notice.html',
})
export class DialogAdminTiffinSubscriptionNotice {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogAdminTiffinSubscriptionNotice>,
