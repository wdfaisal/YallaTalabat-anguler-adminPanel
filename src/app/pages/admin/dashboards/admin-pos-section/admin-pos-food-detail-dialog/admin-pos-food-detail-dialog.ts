...
@Component({
  selector: 'app-admin-pos-food-detail-dialog',
  imports: [MaterialModule, CommonModule, FormsModule, ReactiveFormsModule, NgIcon],
  templateUrl: './admin-pos-food-detail-dialog.html',
})
export class AdminPosFoodDetailDialog {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AdminPosFoodDetailDialog>,
