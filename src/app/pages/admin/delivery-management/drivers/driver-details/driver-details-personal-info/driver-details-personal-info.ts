...
@Component({
  selector: 'app-driver-details-personal-info',
  imports: [MaterialModule, NgApexchartsModule, CommonModule, GoogleMapsModule, NgIcon],
  templateUrl: './driver-details-personal-info.html',
})
export class DriverDetailsPersonalInfo implements AfterViewInit {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/admin/deliveryman_detail/information/' + this.driverId).subscribe({
      next: (response: any) => {
