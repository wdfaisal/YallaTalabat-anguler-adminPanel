...
@Component({
  selector: 'app-driver-details-payout-accounts',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './driver-details-payout-accounts.html',
})
export class DriverDetailsPayoutAccounts implements AfterViewInit {
  ...
  getList() {
    ...
    this.api.get_private('v1/admin/deliveryman_detail/payout_accounts?' + httpParams.toString()).subscribe({
      next: (response: any) => {
