...
@Component({
  selector: 'app-dialog-report-emergency-info',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-report-emergency-info.html',
})
export class DialogReportEmergencyInfo {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogReportEmergencyInfo>,
  ...
  onSubmit() {
    ...
    if (this.replyText != '') {
      ...
      this.api.patch_private('v1/admin/report_emergency/update/', param).subscribe({
        next: (response: any) => {
