...
export class CustomerOrderList implements AfterViewInit {

  @Input() userId!: string;
  @ViewChild('paginator', { read: MatPaginator, static: false }) paginator: MatPaginator;
  orders = new MatTableDataSource<AdminCustomerOrderListInterface>([]);
  ...
  getList() {
    ...
    this.api.get_private('v1/admin/customer/orderList?' + httpParams.toString()).subscribe({
      next: (response: any) => {
        ...
        if (response && response.orders) {
          ...
          this.orders = new MatTableDataSource<AdminCustomerOrderListInterface>(mappedList);
