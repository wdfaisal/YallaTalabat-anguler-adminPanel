...
@Component({
  ...
  templateUrl: './customer-wallet-transactions.html',
})
export class CustomerWalletTransactions implements AfterViewInit {
  ...
  getList() {
    ...
    this.api.get_private('v1/admin/customer/wallet_transactions?' + httpParams.toString()).subscribe({
      next: (response: any) => {
