...
@Component({
  ...
  templateUrl: './customer-personal-detail.html',
})
export class CustomerPersonalDetail implements AfterViewInit {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/admin/customer/detail/' + this.userId).subscribe({
      next: (response: any) => {
