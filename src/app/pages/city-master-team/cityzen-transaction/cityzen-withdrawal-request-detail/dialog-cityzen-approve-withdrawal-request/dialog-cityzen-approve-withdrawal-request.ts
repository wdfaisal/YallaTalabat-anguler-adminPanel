...
@Component({
  selector: 'app-dialog-cityzen-approve-withdrawal-request',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-cityzen-approve-withdrawal-request.html',
})
export class DialogCityzenApproveWithdrawalRequest {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogCityzenApproveWithdrawalRequest>,
  ...
  onSubmit() {
    ...
    if (this.acceptForm.valid) {
      ...
      this.isSubmit = true;
      this.api.post_private('v1/cityzen/approve_withdrawal_request', this.acceptForm.value).subscribe({
        next: (response: any) => {
