...
@Component({
  selector: 'app-cityzen-dining-booking-detail',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './cityzen-dining-booking-detail.html',
})
export class CityzenDiningBookingDetail {
  ...
  getBookingDetail() {
    ...
    this.api.get_private('v1/cityzen/dining_booking_detail/' + this.id).subscribe({
      next: (response: any) => {
