...
@Component({
  selector: 'app-cityzen-table-order-invoice',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './cityzen-table-order-invoice.html',
})
export class CityzenTableOrderInvoice {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/cityzen/cityzen_table_order_invoice/' + this.id).subscribe({
      next: (response: any) => {
