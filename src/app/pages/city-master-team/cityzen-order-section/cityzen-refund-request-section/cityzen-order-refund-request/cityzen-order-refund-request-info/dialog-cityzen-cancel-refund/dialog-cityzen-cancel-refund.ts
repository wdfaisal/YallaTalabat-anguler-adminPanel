...
@Component({
  selector: 'app-dialog-cityzen-cancel-refund',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-cityzen-cancel-refund.html',
})
export class DialogCityzenCancelRefund {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogCityzenCancelRefund>,
  ...
  onSubmit() {
    ...
    if (this.cancelForm.valid) {
      ...
      this.isSubmit = true;
      this.api.post_private('v1/cityzen/refund_request/cancel', this.cancelForm.value).subscribe({
        next: (response: any) => {
