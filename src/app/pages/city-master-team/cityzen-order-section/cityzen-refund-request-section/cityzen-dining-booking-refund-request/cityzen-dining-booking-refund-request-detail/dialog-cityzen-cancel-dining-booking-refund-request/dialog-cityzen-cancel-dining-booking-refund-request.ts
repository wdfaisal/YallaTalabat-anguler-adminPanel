...
@Component({
  selector: 'app-dialog-cityzen-cancel-dining-booking-refund-request',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-cityzen-cancel-dining-booking-refund-request.html',
})
export class DialogCityzenCancelDiningBookingRefundRequest {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogCityzenCancelDiningBookingRefundRequest>,
  ...
  onSubmit() {
    ...
    if (this.cancelForm.valid) {
      ...
      this.isSubmit = true;
      this.api.post_private('v1/cityzen/dining_booking_refund_request/cancel', this.cancelForm.value).subscribe({
        next: (response: any) => {
