...
@Component({
  selector: 'app-cityzen-user-purchased-tiffin-subscription-info',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './cityzen-user-purchased-tiffin-subscription-info.html',
})
export class CityzenUserPurchasedTiffinSubscriptionInfo {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/cityzen/customer_purchased_tiffin_package_detail/' + this.id).subscribe({
      next: (response: any) => {
