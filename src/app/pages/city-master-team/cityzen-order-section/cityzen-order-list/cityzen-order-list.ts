...
@Component({
  selector: 'app-cityzen-order-list',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './cityzen-order-list.html',
})
export class CityzenOrderList implements AfterViewInit {
  ...
  getList() {
    ...
    this.api.get_private('v1/cityzen/order_list/' + this.util.getItem('_uid') + '?' + httpParams.toString()).subscribe({
      next: (response: any) => {
