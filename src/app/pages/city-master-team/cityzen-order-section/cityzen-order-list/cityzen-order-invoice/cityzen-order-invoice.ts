...
@Component({
  selector: 'app-cityzen-order-invoice',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './cityzen-order-invoice.html',
})
export class CityzenOrderInvoice {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/cityzen/cityzen_order_invoice/' + this.id).subscribe({
      next: (response: any) => {
