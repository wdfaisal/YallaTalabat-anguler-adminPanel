...
@Component({
  selector: 'app-cityzen-customer-detail-personal-detail',
  imports: [MaterialModule, NgApexchartsModule, CommonModule, NgIcon],
  templateUrl: './cityzen-customer-detail-personal-detail.html',
})
export class CityzenCustomerDetailPersonalDetail implements AfterViewInit {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/cityzen/customer_detail_info/' + this.userId).subscribe({
      next: (response: any) => {
