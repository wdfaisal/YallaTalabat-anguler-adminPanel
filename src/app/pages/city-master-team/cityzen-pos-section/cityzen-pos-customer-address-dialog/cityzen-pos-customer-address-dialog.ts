...
@Component({
  selector: 'app-cityzen-pos-customer-address-dialog',
  imports: [MaterialModule, CommonModule, FormsModule, ReactiveFormsModule, GoogleMapsModule],
  templateUrl: './cityzen-pos-customer-address-dialog.html',
})
export class CityzenPosCustomerAddressDialog {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CityzenPosCustomerAddressDialog>,
