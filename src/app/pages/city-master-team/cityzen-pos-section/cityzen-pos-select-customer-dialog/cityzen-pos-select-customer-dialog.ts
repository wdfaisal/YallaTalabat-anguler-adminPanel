...
@Component({
  selector: 'app-cityzen-pos-select-customer-dialog',
  imports: [MaterialModule, CommonModule, FormsModule, ReactiveFormsModule, NgIcon],
  templateUrl: './cityzen-pos-select-customer-dialog.html',
})
export class CityzenPosSelectCustomerDialog {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CityzenPosSelectCustomerDialog>,
  ) {
