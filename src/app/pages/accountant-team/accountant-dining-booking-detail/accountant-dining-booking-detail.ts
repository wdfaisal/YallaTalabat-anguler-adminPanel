...
@Component({
  selector: 'app-accountant-dining-booking-detail',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './accountant-dining-booking-detail.html',
})
export class AccountantDiningBookingDetail {
  ...
  getBookingDetail() {
    ...
    this.api.get_private('v1/accountant/dining_booking_detail/' + this.id).subscribe({
      next: (response: any) => {
