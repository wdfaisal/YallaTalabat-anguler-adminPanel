...
@Component({
  selector: 'app-accountant-deliveryman-detail',
  imports: [MaterialModule, NgApexchartsModule, CommonModule, GoogleMapsModule, NgIcon],
  templateUrl: './accountant-deliveryman-detail.html',
})
export class AccountantDeliverymanDetail {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/accountant/deliveryman_detail/' + this.driverId).subscribe({
      next: (response: any) => {
