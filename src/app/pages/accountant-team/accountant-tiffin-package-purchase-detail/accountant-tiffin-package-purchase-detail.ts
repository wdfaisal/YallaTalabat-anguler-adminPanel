...
@Component({
  selector: 'app-accountant-tiffin-package-purchase-detail',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './accountant-tiffin-package-purchase-detail.html',
})
export class AccountantTiffinPackagePurchaseDetail {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/accountant/tiffin_packages_purchase_detail/' + this.id).subscribe({
      next: (response: any) => {
