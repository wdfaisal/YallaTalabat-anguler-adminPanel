...
import { AccountantMediaListDialogInterface } from 'src/app/interfaces/accountant.media.list.interface';
...
@Component({
  selector: 'app-accountant-media-images-dialog',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './accountant-media-images-dialog.html',
})
export class AccountantMediaImagesDialog {

  listOfMedias: AccountantMediaListDialogInterface[] = [];
  pageSize: number = 40;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AccountantMediaImagesDialog>,
  ...
  getList() {
    ...
    this.api.get_private('v1/accountant/media_list?' + httpParams.toString()).subscribe({
      next: (response: any) => {
