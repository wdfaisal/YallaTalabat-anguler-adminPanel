...
@Component({
  selector: 'app-accountant-pos-order-detail',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './accountant-pos-order-detail.html',
})
export class AccountantPosOrderDetail {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/accountant/pos_order_detail/' + this.id).subscribe({
      next: (response: any) => {
