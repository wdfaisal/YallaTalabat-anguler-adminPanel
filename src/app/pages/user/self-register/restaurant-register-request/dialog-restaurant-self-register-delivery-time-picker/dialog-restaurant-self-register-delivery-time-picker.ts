...
@Component({
  selector: 'app-dialog-restaurant-self-register-delivery-time-picker',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-restaurant-self-register-delivery-time-picker.html',
})
export class DialogRestaurantSelfRegisterDeliveryTimePicker {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogRestaurantSelfRegisterDeliveryTimePicker>,
