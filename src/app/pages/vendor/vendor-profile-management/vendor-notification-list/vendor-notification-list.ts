...
export class VendorNotificationList {
  ...
  notification = new MatTableDataSource<VendorNotificationListInterface>([]);
  ...
  getList() {
    ...
    this.api.post_private('v1/vendor_web/notification_list/', param).subscribe({
      next: (response: any) => {
        ...
        if (response && response.results) {
          ...
          this.notification = new MatTableDataSource<VendorNotificationListInterface>(mappedList);
