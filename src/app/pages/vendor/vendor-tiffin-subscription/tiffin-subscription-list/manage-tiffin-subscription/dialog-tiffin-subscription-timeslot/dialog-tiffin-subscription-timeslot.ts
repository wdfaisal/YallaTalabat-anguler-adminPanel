...
@Component({
  selector: 'app-dialog-tiffin-subscription-timeslot',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-tiffin-subscription-timeslot.html',
})
export class DialogTiffinSubscriptionTimeslot {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogTiffinSubscriptionTimeslot>,
