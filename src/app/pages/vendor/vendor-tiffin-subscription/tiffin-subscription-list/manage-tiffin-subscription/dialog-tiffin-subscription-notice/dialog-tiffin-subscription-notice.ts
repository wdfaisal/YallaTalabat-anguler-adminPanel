...
@Component({
  selector: 'app-dialog-tiffin-subscription-notice',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  templateUrl: './dialog-tiffin-subscription-notice.html',
})
export class DialogTiffinSubscriptionNotice {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogTiffinSubscriptionNotice>,
