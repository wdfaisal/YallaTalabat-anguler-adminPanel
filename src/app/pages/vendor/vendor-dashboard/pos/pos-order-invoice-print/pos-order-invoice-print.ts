...
@Component({
  selector: 'app-pos-order-invoice-print',
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MaterialModule, NgIcon],
  templateUrl: './pos-order-invoice-print.html',
})
export class PosOrderInvoicePrint {
  ...
  getInfo() {
    ...
    this.api.get_private('v1/vendor_web/restaurant/pos_invoice_print/' + this.id + '/' + this.util.getItem('_vendorId')).subscribe({
      next: (response: any) => {
